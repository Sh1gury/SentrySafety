// ============ LOGS PAGE — scan history ============

function LogsPage({ scans }) {
            ...
            {filtered.length === 0 ? (
              ...
              <tr
                ...
                className={classNames(
                  selected && selected.id === s.id && 'selected',
              ...
              >
                ...
                <td>
                  <span className="badge badge-neutral">{s.kind}</span>
                </td>
...
// ---------- Slideout for scan detail ----------
function ScanDetailSlideout({ scan, onClose }) {
  useEffect(() => {
        ...
        <div className="slideout-body">
          ...
          <div className="card">
            <div className="kv-grid">
              ...
              <div className="v">{scan.filename || '—'}</div>
              <div className="k">Kind</div>
              <div className="v">{scan.kind}</div>
              <div className="k">Size</div>
              <div className="v">{scan.bytes.toLocaleString()} bytes</div>
              <div className="k">Latency</div>
              <div className="v">{scan.latency} ms</div>
              <div className="k">PII masked</div>
              <div className="v">{scan.pii}</div>
              <div className="k">Threats</div>
              <div className="v">{(scan.threatList || []).join(', ') || '—'}</div>
            </div>
          </div>

          <div className="section-label">Defense layers</div>
          <div className="grid-3" style={{ gridTemplateColumns: '1fr', gap: 10 }}>
